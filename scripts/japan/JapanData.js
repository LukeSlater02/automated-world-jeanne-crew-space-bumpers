const japanCities = [
    ...
    },
    {
        ...
        description: "Yokohama is the second largest city in Japan. Yokohama is the largest port city and hi-tech industrial hub in the Greater Tokyo Area and the Kantō region.",
...
const japanFamousCitizens = [
    {
        name: "Rui Hachimura",
        image:"",
        occupation: "Rui Hachimura is a Japanese professional basketball player for the Washington Wizards of the National Basketball Association. ",
        description: " He joined Gonzaga in 2016 as the fifth Japanese-born men's NCAA Division I player and in 2017 became the first Japanese national to play in the NCAA Division I men's tournament. As a sophomore, he earned first-team All-WCC honors. He was named a finalist for the Naismith Player of the Year.",
    ...
    },
    {
        ...
        description: "In 1948 he started producing a complete motorized bicycle, the Type A, which was driven by the first mass-produced engine designed by Honda, and was sold until 1951. The Type D in 1949 was a true motorcycle with a pressed-steel frame designed and produced by Honda and with a 2-stroke, 98 cc (6.0 cu in) 3 hp (2.2 kW) engine, and became the very first model in the Dream series of motorcycles.",
    ...
    },
    {
        ...
        description: "Suzuki was the first MLB player to enter the Japanese Baseball Hall of Fame.  He achieved 10 consecutive 200-hit seasons, the longest streak by any player in history.",
