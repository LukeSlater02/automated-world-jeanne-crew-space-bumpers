...
export const landmarkObj = [
    ...
    },
    {
        ...
        link: "https://www.grousemountain.com/about",
    },
]

export const citizenObj = [
    {
        name: "Ryan Gosling",
        image: "",
        occupation: "Actor",
        description: "Gosling segued into an acting career, appearing on the TV series Young Hercules (1998), Murder by Numbers (2002), and Remember the Titans (2000). He first attracted serious critical attention with his performance as the Jewish neo-Nazi in the controversial film The Believer (2001), which won the Grand Jury Prize at the 2001 Sundance Film Festival. He was cast in the part by writer-director Henry Bean, who believed that Gosling's strict upbringing gave him the insight to understand the character Danny, whose obsessiveness with the Judaism he was born into turns to hatred. He was nominated for an Independent Spirit Award as Best Male Lead in 2002 for the role and won the Golden Aries award from the Russian Guild of Film Critics.",
        link: "https://www.imdb.com/name/nm0331516/",
    },
    {
        name: "Wayne Gretzky",
        image: "",
        occupation: "Hockey player (retired)",
        description: "If there is one sport that is synonymous with Canada, it is Ice Hockey. One athlete that made a name for himself in this sport is Wayne Gretzky. He is the most famous and successful hockey player of all time. Wayne holds forty regular-season records, fifteen playoff records, and six All-Star records. Not only was he the leading point-scorer in NHL history, but also the only NHL player to total over 200 points in one season. He accomplished this four times while tallying over 100 points in 16 professional seasons.",
    ...
    },
    {
        ...
        description: "Justin Trudeau is Canada’s 23rd Prime Minister. He grew up under the great influence of his father, Pierre Elliot Trudeau, and his mother Margret Trudeau. He is the oldest of three boys and speaks both French and English. This background sparked his passion for public service and shaped his belief that diversity is Canada’s strength. Before diving into politics, Justin served as the Chair of Katimavik, on the board for the Canadian Avalanche Foundation. He was also an advocate for young people and the environment. Since his early youth, he has been encouraging young people to engage with the issues important to them and participate as active citizens.",
